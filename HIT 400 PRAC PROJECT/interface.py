...
label.pack(side=TOP)
filename = PhotoImage(file="C:/Users/pcRUX/Desktop/HIT 400 PRAC PROJECT/rUX PROD.png")
...
subm1.add_command(label="Admin Authentication", command=hel)
subm1.add_command(label="Admin Registration", command=hel)
...
but1=Button(frame, padx=5, pady=5, width=39,bg='grey', fg='black', relief=GROOVE, command=hel, text='Launch Cam',font=('helvetica 16 bold'))
